...
namespace dd4hep {
  ...
  namespace sim   {
     ...
     *
     * @{
     * \package DualCrystalHcalSDAction
     *
     * @}
     */

    /// Define collections created by this sensitivie action object
    template <> void Geant4SensitiveAction<DualCrystalHcalSD>::defineCollections()    {
      m_collectionID = declareReadoutFilteredCollection<CalVision::DualCrystalHcalSD::Hit>();
    }

    /// Method for generating hit(s) using the information of G4Step object.
    template <> bool Geant4SensitiveAction<DualCrystalHcalSD>::process(const G4Step* step,G4TouchableHistory* /*hist*/ ) {
...
//--- Factory declaration
namespace dd4hep { namespace sim {
    typedef Geant4SensitiveAction<DualCrystalHcalSD> DualCrystalHcalSDAction;
  }}
DECLARE_GEANT4SENSITIVE(DualCrystalHcalSDAction)
